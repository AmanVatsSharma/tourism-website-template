...
# 5. FAQ_SCHEMA.JSON - Complete with all 20 FAQs
faq_schema = {
    ...
    "mainEntity": [
        {
            "@type": "Question",
            "name": "What is Adi Kailash and why is it significant?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Adi Kailash, also known as Chhota Kailash or Baba Kailash, is a sacred mountain located at 5,945 meters in Pithoragarh district of Uttarakhand, India. It is the second most important peak among the Panch Kailash (Five Kailashas) and is revered as the earthly abode of Lord Shiva. After the Chinese occupation of Tibet made Mount Kailash difficult to access, Adi Kailash has become the most accessible alternative for Hindu pilgrims seeking Lord Shiva's blessings without crossing international borders."
            }
        },
        {
            "@type": "Question",
            "name": "What is the best time to visit Adi Kailash?",
            "acceptedAnswer": {
                "@type": "Answer",
...
print("✅ Created: faq_schema.json (Complete with 20 FAQs)")
